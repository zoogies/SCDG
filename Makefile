...
$(BUILD_DIR_LINUX)/game_linux: $(BUILD_DIR_LINUX)/game.o $(BUILD_DIR_LINUX)/engine.o $(BUILD_DIR_LINUX)/audio.o $(BUILD_DIR_LINUX)/graphics.o $(BUILD_DIR_LINUX)/logging.o $(BUILD_DIR_LINUX)/discord.o
	$(CC) $(CFLAGS) $^ $(LIBS) -o $@
...
$(BUILD_DIR_WINDOWS)/game_windows.exe: $(BUILD_DIR_WINDOWS)/game.o $(BUILD_DIR_WINDOWS)/engine.o $(BUILD_DIR_WINDOWS)/audio.o $(BUILD_DIR_WINDOWS)/graphics.o $(BUILD_DIR_LINUX)/logging.o $(BUILD_DIR_WINDOWS)/discord.o
	$(CC) $(CFLAGS) $^ $(LIBS) -o $@
